...
% Setzt global "Woche" anstelle von "Kapitel" (angepasst an swissgerman)
\addto\captionsswissgerman{\renewcommand{\chaptername}{Woche}}
...
\colorlet{SubSecBar1}{ThemePrimary}
\colorlet{SubSecBar2}{ThemePrimary!70!white}
\colorlet{SubSecBar1Proof}{SubSecBar1!50!ProofTint}
\colorlet{SubSecBar2Proof}{SubSecBar2!50!ProofTint}
\colorlet{SubSecTitleColor}{ThemePrimary}
...
\setlist[enumerate]{
  ...
  label=\textcolor{EnumerateBullet}{\bfseries(\alph*)}, % ItemizeBullet statt EnumerateBullet
  ref=(\alph*)
}
...
% Custom text commands & transcript anchors
...
% Spoken protocol anchors: (...) for minor spoken additions, [...] for major editorial context
\newcommand{\spokenminor}[1]{\textcolor{TextMetaNote}{(#1)}}
\newcommand{\spokenmajor}[1]{\textcolor{TextMetaNote}{[#1]}}
...
\Crefname{example}{Beispiel}{Beispiele}
\crefname{examples}{Beispiel}{Beispiele}
\Crefname{examples}{Beispiel}{Beispiele}
...
\newenvironment{short-proof}[1][Beweis]{
    \par\if@nobreak\vspace{-1ex}\else\addvspace{1.2ex plus 0.3ex minus 0.2ex}\fi
    \insideprooftrue 
    \noindent\textcolor{ProofTint}{\faPenNib}\hspace{0.5em}%
    {\normalfont\sffamily\bfseries\color{ProofTint}#1}%
    \par\nobreak\vspace{0.6ex plus .1ex}\vspace{-\parskip}
...
\renewenvironment{proof}[1][Beweis]{
    \par\if@nobreak\vspace{-1ex}\else\addvspace{1.8ex plus 0.5ex minus 0.2ex}\fi
    \insideprooftrue 
...
\begin{minipage}{\textwidth}
    ...
    \vspace{2.0cm}
    {\sffamily\fontsize{18pt}{24pt}\selectfont\bfseries\color{TextEmphColor} Vorlesungstranskript \& Mitschrift \par}
    \vspace{0.6cm}
...
\begin{minipage}{\textwidth}
    ...
    {\sffamily\bfseries\small\color{MidnightBlue!90!black}\faInfoCircle\quad Hinweispflicht \& Transkriptions-Disclaimer \par}
    \vspace{0.25cm}
    \sffamily\small\color{black!75}
    \begin{itemize}[leftmargin=1.5em, itemsep=3pt, topsep=0pt, parsep=0pt]
        \item[\textcolor{MidnightBlue!80!black}{\small\faRobot}] \textbf{KI-generierte Mitschrift:} Dieses Dokument wurde automatisiert mittels KI/LLM-Systemen (audio- und bildbasierte Transkription) aus den Vorlesungsaufzeichnungen erstellt.
        \item[\textcolor{MidnightBlue!80!black}{\small\faUserShield}] \textbf{Inoffizielles Dokument:} Es handelt sich um \emph{kein} offizielles Unterrichtsmaterial der ETH Zürich oder der Dozenten und wurde \emph{nicht} manuell korrigiert oder gegengelesen (unreviewed draft).
        \item[\textcolor{MidnightBlue!80!black}{\small\faExclamationTriangle}] \textbf{Haftungsausschluss:} Künstliche Intelligenzen können Fehler machen (z.\,B. Notation, Indizes oder logische Zusammenhänge). Nutzung auf eigene Verantwortung --- ohne Gewähr für Richtigkeit, Vollständigkeit oder Prüfungsrelevanz.
    \end{itemize}
    \end{tcolorbox}
\end{minipage}
\vspace*{0.5cm}
...
\include{content/week1-02-17-25-tuesday.tex}

\include{content/week2-02-24-25-tuesday.tex}

\include{content/week3-03-03-25-tuesday.tex}

\include{content/week4-03-10-25-tuesday.tex}

\include{content/week5-03-17-25-tuesday.tex}

\include{content/week6-03-24-25-tuesday.tex}

\include{content/week7-03-31-25-tuesday.tex}


% Easter Break


\include{content/week8-04-14-25-tuesday.tex}

\include{content/week9-04-21-25-tuesday.tex}

% \include{content/week10-04-28-25-tuesday.tex}

\include{content/week10-step4-04-28-25-tuesday-all-offset-final.tex}

\include{content/week11-05-05-25-tuesday.tex}

%\include{content/week11-step4-05-05-25-tuesday-all-offset-final.tex}

\include{content/week12-05-12-25-tuesday.tex}

\include{content/week13-05-19-25-tuesday.tex}

\include{content/week14-05-26-25-tuesday.tex}
