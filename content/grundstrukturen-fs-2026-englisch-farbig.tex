...
\begin{minipage}{\textwidth}
    ...
    \vspace{2.0cm}
    {\sffamily\fontsize{18pt}{24pt}\selectfont\bfseries\color{TextEmphColor} Lecture Notes \par}
    \vspace{0.6cm}
...
\vfill
\begin{minipage}{\textwidth}
    {\sffamily\small\color{HeaderFooterFaint} LLM-assisted lecture notes at ETH Zurich $\cdot$ FS 2026}
\end{minipage}
\vspace*{1.5cm}
\end{titlepage}
