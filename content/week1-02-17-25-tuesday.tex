...
\begin{itemize}
    ...
    \item Wir bezeichnen mit $\operatorname{frei}(\varphi)$ die Menge aller Variablen, die in $\varphi$ mindestens ein freies Vorkommen besitzen (bezogen auf die Menge $\operatorname{var}(\tau)$ der Variablen in ihren Termen, vgl. \cref{def:variablen-in-term}).
\end{itemize}
\end{definition}
\end{math-stroke}
