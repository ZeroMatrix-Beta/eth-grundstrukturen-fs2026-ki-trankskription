...
\begin{equation}
\forall \mathcal{F} \left( \emptyset \notin \mathcal{F} \implies \exists f \left( f \in {}^{ \mathcal{F}}\!\bigcup \mathcal{F} \land \forall X \in \mathcal{F} \, (f(X) \in X) \right) \right)
\end{equation}
\end{axiom}
\end{math-stroke}
\begin{didactic-insight}
One coulde also have written $f: \mathcal{F} \to \bigcup \mathcal{F}$ instead of $f \in {}^{ \mathcal{F}}\!\bigcup \mathcal{F}$. However, the latter is more common in the lecture.
