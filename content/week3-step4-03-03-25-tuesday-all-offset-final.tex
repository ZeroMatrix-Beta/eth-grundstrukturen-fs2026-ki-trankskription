...
\lecturechapter{Dienstag}{03. Mär}{3. März 2025}{Peano-Arithmetik und formale Beweise}
...
Folgende Axiome bilden den Kern der Peano-Arithmetik:
\begin{align}
...
\begin{explanation-of-steps}[Warum ein Schema?]
...
\begin{math-stroke}[Formale Verifikation und LEAN]
\begin{center}
...
\begin{math-stroke}[Übung: Addition und Multiplikation]
...
\begin{math-stroke}[Satz: Multiplikation mit 2]
\begin{proposition}
    \label{prop:2x_is_xx}
...
\begin{math-stroke}[Beispiel: Struktur der Gruppentheorie]
...
\begin{math-stroke}[Interpretation]
...
\begin{enumerate}[label=\textbf{(W\arabic*)}, start=0]
...
Wir können auch einfachere Beispiele anschauen. Machen wir da irgendetwas\dots man kann das ein bisschen selbst ausprobieren. Sagen wir, die Signatur $\mathcal{L}$ sei einfach $\{c, F\}$. Wir legen fest: $c$ ist ein Konstantensymbol und $F$ soll ein einstelliges Funktionssymbol sein.
