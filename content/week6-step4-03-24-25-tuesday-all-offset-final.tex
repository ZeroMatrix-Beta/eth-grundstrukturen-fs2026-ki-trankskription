...
\lecturechapter{Dienstag}{24. Mär}{24. März 2025}{Konstruktion der reellen Zahlen}
...
\begin{itemize}
    \item \textbf{(D0)} stellt sicher, dass der Schnitt eine echte Aufteilung der rationalen Zahlen darstellt.
    \item \textbf{(D1)} erzwingt, dass $\alpha$ ein \qt{Anfangsstück} der rationalen Zahlen ist.
    \item \textbf{(D2)} sorgt für eine eindeutige Darstellung. Ohne diese Bedingung könnte man eine rationale Zahl $r$ sowohl durch $\{q \in \mathbb{Q} \mid q < r\}$ als auch durch $\{q \in \mathbb{Q} \mid q \le r\}$ repräsentieren. Durch den Ausschluss des Maximums wählen wir die \qt{offene} Variante.
\end{itemize}
\end{explanation-of-steps}
\end{math-stroke}
...
\begin{definition}[Additives Inverses]\label{def:additives-inverses}
...
\begin{math-stroke}[Die Ordnung auf den reellen Zahlen]
