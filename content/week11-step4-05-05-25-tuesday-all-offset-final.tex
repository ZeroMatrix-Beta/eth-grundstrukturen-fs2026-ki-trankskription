...
Und das können wir hier noch mit dieser Proposition abschließen --- das ist der Satz von Euler (\cref{prop:satz-von-euler}). Sie besagt, dass ein endlicher, ungerichteter, zusammenhängender Graph $G$ --- zusammenhängend haben wir, glaube ich, noch nicht definiert, aber das heißt einfach genau das, was man denkt: Wenn man je zwei beliebige Knoten nimmt, dann existiert ein Kantenzug zwischen ihnen, man kann also je zwei Knoten verbinden --- genau dann ein Euler-Graph ist, wenn jeder Knoten von $G$ einen geraden Grad hat.
\end{spoken-clean}
