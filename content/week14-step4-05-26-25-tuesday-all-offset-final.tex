...
\lecturechapter{Dienstag}{26. Mai}{26. Mai 2025}{Polynomringe, Restklassenkörper und endliche Körper}
...
Gut, und als weitere Bemerkung --- was ich jetzt hier nicht im Detail vorrechne ---: Man kann genau dasselbe machen wie in $\mathbb{Z}$ mit dem euklidischen Algorithmus. Auch in diesem Fall (Polynomring) kann man den euklidischen Algorithmus anwenden, um den $\operatorname{ggT}$ sowie die Bézout-Koeffizienten $A$ und $B$ zu bestimmen. Also...
\end{spoken-clean}
...
Das Nächste, was wir haben, ist das Analogon zum Lemma von Euklid. Es besagt: Wenn ein irreduzibles Polynom ein Produkt teilt, dann muss es bereits mindestens einen der Faktoren teilen. 
